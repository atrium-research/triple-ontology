...
This directory is what gets deployed under `https://gotriple.eu/ontology/`. At the
root, `index.html` is the landing page — one card per artefact, generated by the
build (`scripts/build_index.py`, driven by `build_docs.sh`). Below it, one
