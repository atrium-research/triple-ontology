...
| `datacite:doi` | Identifier scheme: DOI — Digital Object Identifier for datasets. Identifiers using it are plain `datacite:Identifier`. |
| `datacite:handle` | Identifier scheme: Handle — persistent identifier system for datasets. Identifiers using it are plain `datacite:Identifier`. |
...
| `triple:hasConditionOfAccess`    | Property connecting a dataset to its access conditions.                                                                                             |
