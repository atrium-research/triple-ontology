...
| `triple:handle` | Handle System scheme for persistent identifier infrastructure. |
| `triple:uri` | Uniform Resource Identifier scheme for unambiguous resource identification. |
