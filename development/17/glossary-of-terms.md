...
| Term                                | Definition                                                                                                                                                        |
|-------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `triple:originalAdditionalType`               | A datatype property preserving the resource type exactly as received from the source provider, before normalization to the Content Type vocabulary. Sub-property of `dc:type`. |
| `triple:originalInLanguage`           | A datatype property preserving the language value exactly as received from the source provider, before normalization to a `schema:Language` entity. Sub-property of `dc:language`. |
...
| `triple:originalConditionOfAccess` | A datatype property preserving the access rights statement exactly as received from the source provider, before normalization to the Condition of Access vocabulary. Sub-property of `dc:rights`. |
...
| `dc:type`                           | The Dublin Core Elements 1.1 property for the nature or genre of the resource; used as the interoperable super-property of `triple:originalAdditionalType`.                  |
| `dc:language`                       | The Dublin Core Elements 1.1 property for the language of the resource; used as the interoperable super-property of `triple:originalInLanguage`.                     |
...
| `dc:rights`                         | The Dublin Core Elements 1.1 property for rights information about the resource; used as the interoperable super-property of `triple:originalLicense` and `triple:originalConditionOfAccess`. |
