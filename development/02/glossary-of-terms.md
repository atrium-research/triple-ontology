...
| `triple:ConditionOfAccess`       | Bridge class. Subclass of `skos:Concept` and `dcterms:RightsStatement`. Used for access condition terms.                                                             |
...
| `triple:hasConditionOfAccess`    | Property linking a document to a `triple:ConditionOfAccess`. Subproperty of `dcterms:accessRights`.                                                                    |
