...
The extension builds upon the existing Document model while introducing specialized properties for Schema.org multimedia types (MediaObject, VideoObject, ImageObject, AudioObject).

## Technical Specification
- Extend the TRIPLE ontology to support multimedia content types through Schema.org multimedia classes
